...
To visualize them, it appeared that building word clouds was the most effective way. We will analize them in the executive summary. 
Let's start with all our n-gram (unigram, bigram, trigram) by decade:
...
Unigrams are dominant in those clouds, which was expected.
Let's focus on them:
