...
‘The loudness war (or loudness race) refers to the trend of increasing audio levels in recorded music which many critics believe reduces sound quality and listener enjoyment.’[wiki](wikipedia.org/wiki/Loudness_war#1980s)
...
2) A general decline in instruemntal music, there has been a large decline in instrumental artists and thus music. There is a comprehensive [CNN article](https://www.cnn.com/2016/05/29/opinions/classical-music-dying-and-being-reborn-opinion-albright/index.html) detailing the reasons.

### Bleep Bleepin' Bleep

Damn.

I'm sure that reference was clear? Well, Kendrick Lamar Just won the [Pulitzer Prize](http://www.pulitzer.org/winners/kendrick-lamar) for music. Its the first time in the history of music that a Rap artist has won the pulitzer prize. 
...
wordcloud(most_explicit_words$word, most_explicit_words$explicit_scale, scale=c(1.5, .2), random.order = FALSE, random.color = FALSE, colors= pal)
```
```
### Conclusion
